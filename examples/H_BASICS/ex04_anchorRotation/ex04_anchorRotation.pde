...
void setup() {
	...
	s4 = new HEllipse(25);
	s4.noStroke().fill(#CCCCCC).anchor( new PVector(12.5,75) ).loc(100,height-180).extras(new HBundle().num( "letsRotate", random(-2,-1) ));
	H.add(s4);

	s5 = new HEllipse(25);
	s5.noStroke().fill(#CCCCCC).anchor( new PVector(12.5,75) ).loc(width/2,height-180).extras(new HBundle().num( "letsRotate", random(-4,-2) ));
	H.add(s5);

	s6 = new HEllipse(25);
	s6.noStroke().fill(#CCCCCC).anchor( new PVector(12.5,75) ).loc(width-100,height-180).extras(new HBundle().num( "letsRotate", random(-8,-4) ));
	H.add(s6);
}
