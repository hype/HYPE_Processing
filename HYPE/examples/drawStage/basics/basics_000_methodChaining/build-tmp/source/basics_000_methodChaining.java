...
public class basics_000_methodChaining extends PApplet {
...
public void setup() {
	...
	rect3.rounding(10).strokeWeight(6).stroke(0xFF000000, 150).fill(0xFFFFCC00).anchorAt(H.CENTER).rotation(45).loc(394,height / 2);
	H.add(rect3);
...
public void draw() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "basics_000_methodChaining" };
    if (passedArgs != null) {
