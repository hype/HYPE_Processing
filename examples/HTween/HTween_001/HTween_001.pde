...
void setup() {
	...
	t2b = new HTween().target(r2).property(H.SCALE).start(0).end(100).ease(0.005).spring(0.95);
	...
	t3b = new HTween().target(r3).property(H.SCALE).start(0).end(100).ease(0.005).spring(0.95);
