...
public class basics_001_drawingShapes extends PApplet {
...
// ************************************************************************************ ROW 2
	...
	s6
		...
		.stroke(0xFF666666) // set color to #666666
		.fill(0xFFECECEC)
		.size(150, 100)
		.loc(150,200)
	;
...
// ************************************************************************************ ROW 3
	...
	s10
		.rounding(10)
		.strokeWeight(6)
		.stroke(0xFF000000, 150) // stroke with alpha 200
		.fill(0xFFECECEC, 50) // fill with alpha 50
		.loc(200,350)
	;
	H.add(s10);
	...
	s11
		...
		.fill(0xFFECECEC) // no fill color alpha
		.loc(350,350)
	;
	H.add(s11);
	...
	s12
		.rounding(10)
		.noStroke()
		.fill(0xFFFF6600) // so many different ways to set color / #FF6600 hex value or #FF6600, 50 hex value and alpha
		.loc(500,350)
	;
	H.add(s12);
...
public void draw() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "basics_001_drawingShapes" };
    if (passedArgs != null) {
